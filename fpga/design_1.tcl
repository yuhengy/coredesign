...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_bram_ctrl_1_bram_doutb [get_bd_pins axi_bram_ctrl_1_bram/doutb] [get_bd_pins fpgaTOP_0/io_inst_from_douta]
  connect_bd_net -net axi_bram_ctrl_2_bram_doutb [get_bd_pins axi_bram_ctrl_2_bram/doutb] [get_bd_pins fpgaTOP_0/io_data_from_douta]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins fpgaTOP_0/io_diffTest_from_douta]
  connect_bd_net -net fpgaTOP_0_io_data_to_addra [get_bd_pins axi_bram_ctrl_2_bram/addrb] [get_bd_pins fpgaTOP_0/io_data_to_addra]
  connect_bd_net -net fpgaTOP_0_io_data_to_dina [get_bd_pins axi_bram_ctrl_2_bram/dinb] [get_bd_pins fpgaTOP_0/io_data_to_dina]
  connect_bd_net -net fpgaTOP_0_io_data_to_ena [get_bd_pins axi_bram_ctrl_2_bram/enb] [get_bd_pins fpgaTOP_0/io_data_to_ena]
  connect_bd_net -net fpgaTOP_0_io_data_to_wea [get_bd_pins axi_bram_ctrl_2_bram/web] [get_bd_pins fpgaTOP_0/io_data_to_wea]
  connect_bd_net -net fpgaTOP_0_io_diffTest_addra [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins fpgaTOP_0/io_diffTest_addra]
  connect_bd_net -net fpgaTOP_0_io_diffTest_to_dina [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins fpgaTOP_0/io_diffTest_to_dina]
  connect_bd_net -net fpgaTOP_0_io_diffTest_to_ena [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins fpgaTOP_0/io_diffTest_to_ena]
  connect_bd_net -net fpgaTOP_0_io_diffTest_to_wea [get_bd_pins blk_mem_gen_0/web] [get_bd_pins fpgaTOP_0/io_diffTest_to_wea]
  connect_bd_net -net fpgaTOP_0_io_goodTrap [get_bd_pins fpgaTOP_0/io_goodTrap] [get_bd_pins processing_system7_0/GPIO_I]
  connect_bd_net -net fpgaTOP_0_io_inst_to_addra [get_bd_pins axi_bram_ctrl_1_bram/addrb] [get_bd_pins fpgaTOP_0/io_inst_to_addra]
  connect_bd_net -net fpgaTOP_0_io_inst_to_dina [get_bd_pins axi_bram_ctrl_1_bram/dinb] [get_bd_pins fpgaTOP_0/io_inst_to_dina]
  connect_bd_net -net fpgaTOP_0_io_inst_to_ena [get_bd_pins axi_bram_ctrl_1_bram/enb] [get_bd_pins fpgaTOP_0/io_inst_to_ena]
  connect_bd_net -net fpgaTOP_0_io_inst_to_wea [get_bd_pins axi_bram_ctrl_1_bram/web] [get_bd_pins fpgaTOP_0/io_inst_to_wea]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1_bram/clkb] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2_bram/clkb] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins fpgaTOP_0/clock] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins fpgaTOP_0/reset] [get_bd_pins xlslice_0/Dout]
